...
### Research Vision
My research focuses on developing **trustworthy AI agents** that operate reliably in complex, uncertain, and dynamic environments. By advancing methods in **uncertainty representation**, **scalable exploration**, and **language-based reasoning**, I bridge foundational theory with real-world applications in reinforcement learning (**RL**) and large language models (**LLMs**). My work impacts fields including automated decision-making, medical triage, and multi-agent learning. I aim to create resilient, transparent, and ethical AI systems.
